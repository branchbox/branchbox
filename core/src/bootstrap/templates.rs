...
///
/// Note: The new modular devcontainer system is preferred. This function
/// is kept for backward compatibility.
#[deprecated(
    since = "0.6.0",
    note = "Use devcontainer::DevcontainerBuilder for new code"
)]
pub fn devcontainer_json(stack: Stack) -> Result<String> {
    let template = match stack {
        ...
        // Python uses generic template in legacy system; new code uses DevcontainerBuilder
        Stack::Python | Stack::Generic => include_str!("templates/generic/devcontainer.json"),
    };
...
pub fn compose_yaml(stack: Stack) -> Result<String> {
    let template = match stack {
        ...
        Stack::Python | Stack::Generic => include_str!("templates/generic/compose.yaml"),
    };
...
pub fn dockerfile(stack: Stack) -> Result<String> {
    let template = match stack {
        ...
        Stack::Python | Stack::Generic => include_str!("templates/generic/Dockerfile"),
    };
...
pub fn env_sample(stack: Stack) -> Result<String> {
    let template = match stack {
        ...
        Stack::Python | Stack::Generic => include_str!("templates/generic/env.sample"),
    };
