...
- **2025-10-31**: Ported spec lifecycle bootstrap: backlog specs are auto-discovered, moved to `in-progress`, and frontmatter is refreshed during `feature start`. Added unit coverage for the new path.
