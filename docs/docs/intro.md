...
- Want to understand how specs, adapters, and modules work together? Visit the **Architecture Overview** and **Specs Workflow** chapters.

> Note: This site is evolving. If a page is missing details, check the linked Markdown files in the repository and contribute updates via pull requests.
